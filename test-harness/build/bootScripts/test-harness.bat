...
set JARPATH=%APP_HOME%\lib\test-harness.jar

@rem Execute test-harness
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %TEST_HARNESS_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%TEST_HARNESS_EXIT_CONSOLE%" exit 1
exit /b 1
