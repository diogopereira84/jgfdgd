...
public record AggregationResult(Double averageMessageAcceptanceLatency,
                                long maximumMessageAcceptanceLatency,
                                long minimumMessageAcceptanceLatency,
                                List<Double> messageAcceptanceLatencyPercentiles,
                                Double averageEndToEndLatency,
                                long maximumEndToEndLatency,
                                long minimumEndToEndLatency,
                                List<Double> externalEndToEndLatencyPercentiles) {
}