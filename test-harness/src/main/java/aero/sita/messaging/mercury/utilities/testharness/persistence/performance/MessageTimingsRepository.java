...
public interface MessageTimingsRepository extends MongoRepository<MessageTimingsDocument, String> {
  Optional<MessageTimingsDocument> findByTestHarnessMessageId(String messageId);
}
